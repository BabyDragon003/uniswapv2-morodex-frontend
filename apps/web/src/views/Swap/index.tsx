...
export default function Swap() {
  ...
  return (
    <Page removePadding={isChartExpanded} hideFooterOnDesktop={isChartExpanded}>
      <Flex width="100%" maxWidth="576px" height="100%" justifyContent="center" position="relative" alignItems="flex-start">
        ...
        <Flex flexDirection="column" width="100%" maxWidth="576px">
